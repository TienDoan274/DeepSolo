...
_C.MODEL.TRANSFORMER.NUM_QUERIES = 1000
...
_C.MODEL.TRANSFORMER.LANGUAGE.CLASSES = ["Arabic","Bangla","Chinese","Hindi","Japanese","Korean","Latin","Symbols"]
_C.MODEL.TRANSFORMER.LANGUAGE.VOC_SIZES = [("Arabic", 72),
                                           ("Bangla", 109),
                                           ("Chinese", 5197),
                                           ("Hindi", 107),
                                           ("Japanese", 2294),
